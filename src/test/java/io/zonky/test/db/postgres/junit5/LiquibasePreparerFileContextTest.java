...
class LiquibasePreparerFileContextTest {
    ...
    @RegisterExtension
    PreparedDbExtension db = EmbeddedPostgresExtension.preparedDatabase(LiquibasePreparer.forFile(new File("src/test/resources/liqui/master-test.xml"), new Contexts("test")));
